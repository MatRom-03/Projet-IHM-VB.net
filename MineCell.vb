Public Class MineCell
    ...
    Public Sub decovery()
        ...
        If Not value = MineStates.BombCell Then
            GameFunction.CellDiscoveredCount()
        End If
    End Sub
