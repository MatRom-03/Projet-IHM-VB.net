...
Public Class INIFileAccess
    ...
    Public Shared Function ReadINI(ByVal File As String, ByVal Section As String, ByVal Key As String) As String
        ...
        GetPrivateProfileString(Section, Key, Application.StartupPath, sb, sb.Capacity, Application.StartupPath & "\" & File)
        Return sb.ToString
    End Function

    Public Shared Sub WriteINI(ByVal File As String, ByVal Section As String, ByVal Key As String, ByVal Value As String)
        WritePrivateProfileString(Section, Key, Value, Application.StartupPath & "\" & File)
    End Sub
End Class
